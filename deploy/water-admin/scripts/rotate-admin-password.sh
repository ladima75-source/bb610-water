...
if [ -n "${BB610_ADMIN_NEW_PASSWORD:-}" ]; then
  PASS1="$BB610_ADMIN_NEW_PASSWORD"
  PASS2="$BB610_ADMIN_NEW_PASSWORD"
else
  [ -t 0 ] || { echo "Interactive terminal required or set BB610_ADMIN_NEW_PASSWORD" >&2; exit 2; }
...
unset PASS1 PASS2 NEW_PASSWORD BB610_ADMIN_NEW_PASSWORD
