...
Rendered validation is executed against staging at 1440, 1024, 768, 390 and 360 px. The CI review harness checks:

- page overflow;
- navigation anchors and mobile menu;
- JS/console errors;
- broken HTTP resources and images;
- commercial 7×3 invariant and six PRICE_ON_REQUEST rows;
- F1-P and F2-P configurator state and CTA;
- missing PULS assets degrading gracefully;
- absence of localhost/127.0.0.1 endpoint in public runtime;
- screenshots from the actually rendered staging page.

Detailed output: `docs/website/review/r21/VALIDATION.md` and `docs/website/review/r21/validation.json` (generated by review CI).
...
- `docs/website/review/r21/**` (generated review evidence)

## Commit

Final review commit SHA: **pending rendered-review evidence commit**.
