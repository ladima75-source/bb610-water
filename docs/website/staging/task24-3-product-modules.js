(()=>{
  ...
  function injectStyles(){
    ...
    s.textContent=`
#architecture{padding:20px 0 18px!important;background:linear-gradient(180deg,rgba(4,17,28,.98),rgba(3,14,24,.98))}
#architecture .a236{width:min(1320px,calc(100% - 40px));margin:0 auto;display:grid;gap:14px;color:var(--text-1)}
.a236-head{text-align:center;display:grid;gap:5px}.a236-head h2{margin:0;font-size:clamp(30px,2.6vw,44px);line-height:1.04;letter-spacing:-.025em}.a236-head p{margin:0;color:var(--text-2);font-size:17px}
.a236-grid{display:grid;grid-template-columns:minmax(330px,.82fr) minmax(650px,1.55fr);gap:18px;align-items:stretch}
...
.a236-right{display:grid;grid-template-rows:auto 1fr auto;gap:12px}.a236-flow{display:grid;grid-template-columns:1.05fr 24px .8fr 24px .9fr 24px .82fr 24px 1.18fr;align-items:center;gap:0;min-height:225px}.a236-node{min-width:0;border:1px solid rgba(45,182,239,.5);border-radius:12px;padding:13px 10px;text-align:center;background:rgba(8,31,48,.55);display:grid;justify-items:center;gap:8px}.a236-node.zone{border-color:rgba(47,210,154,.7)}.a236-node svg{width:44px;height:44px;fill:none;stroke:#20c8ff;stroke-width:2.4}.a236-node.zone svg{stroke:#39d6a0}.a236-node h3{margin:0;font-size:15px;color:#19c2ff}.a236-node.zone h3{color:#39d6a0}.a236-node p{margin:0;color:var(--text-2);font-size:12px;line-height:1.3}.a236-arrow{height:2px;background:#27bdf0;position:relative}.a236-arrow:after{content:"";position:absolute;right:-1px;top:-4px;border-left:8px solid #27bdf0;border-top:5px solid transparent;border-bottom:5px solid transparent}
.a236-zones{display:grid;gap:10px}.a236-zones-title{font-weight:800;font-size:15px}.a236-zones-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:6px}.a236-zone{display:grid;justify-items:center;gap:3px}.a236-zone svg{width:28px;height:28px;fill:none;stroke:#39d6a0;stroke-width:2}.a236-zone span{font-size:11px;color:var(--text-2)}.a236-eq{font-size:11px;color:#9fc3db}
...
@media(max-width:900px){#architecture{padding:28px 0 26px!important}#architecture .a236{width:min(620px,calc(100% - 28px));gap:16px}.a236-head{text-align:left}.a236-head h2{font-size:clamp(28px,9vw,38px)}.a236-head p{font-size:16px}.a236-grid{grid-template-columns:1fr}.a236-left,.a236-right{padding:16px}.a236-flow{grid-template-columns:1fr;gap:9px}.a236-arrow{width:2px;height:20px;justify-self:center}.a236-arrow:after{right:-4px;top:auto;bottom:-1px;border-left:5px solid transparent;border-right:5px solid transparent;border-top:8px solid #27bdf0;border-bottom:0}.a236-node{width:100%}.a236-outside{grid-template-columns:1fr;gap:8px;text-align:center}.a236-mini-arrow{width:2px;height:14px;justify-self:center}.a236-mini-arrow.in{width:2px;height:16px}.a236-mini-arrow.in:after{right:-4px;top:auto;bottom:-1px;border-left:5px solid transparent;border-right:5px solid transparent;border-top:8px solid #27bdf0;border-bottom:0}.a236-zones-grid{gap:5px}}
`;
