...
.a236-head{text-align:center;display:grid;gap:5px;justify-items:center}.a236-head h2{margin:0;font-size:clamp(30px,2.6vw,44px);line-height:1.04;letter-spacing:-.025em}.a236-head p{margin:0;color:var(--text-2);font-size:17px}
...
.a236-right{display:grid;grid-template-rows:auto 1fr auto;gap:12px}.a236-flow{display:grid;grid-template-columns:1fr 26px 1fr 26px 1fr 26px 1fr 26px 1fr;align-items:stretch;gap:0;min-height:300px}.a236-node,.a236-zones{min-width:0;height:100%;box-sizing:border-box;border:1px solid rgba(45,182,239,.5);border-radius:12px;padding:18px 12px;text-align:center;background:rgba(8,31,48,.55);display:grid;align-items:center;justify-items:center;gap:10px}.a236-node{grid-template-rows:auto auto 1fr}.a236-node.zone{border-color:rgba(47,210,154,.7)}.a236-node svg{width:58px;height:58px;fill:none;stroke:#20c8ff;stroke-width:2.4}.a236-node.zone svg{stroke:#39d6a0}.a236-node h3{margin:0;font-size:16px;color:#19c2ff}.a236-node.zone h3{color:#39d6a0}.a236-node p{margin:0;color:var(--text-2);font-size:12.5px;line-height:1.35}.a236-arrow{height:2px;background:#27bdf0;position:relative;align-self:center}.a236-arrow:after{content:"";position:absolute;right:-1px;top:-4px;border-left:8px solid #27bdf0;border-top:5px solid transparent;border-bottom:5px solid transparent}
.a236-zones{grid-template-rows:auto 1fr auto}.a236-zones-title{font-weight:800;font-size:16px;color:var(--text-1)}.a236-zones-grid{width:100%;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;align-self:center}.a236-zone{min-width:0;min-height:104px;border:1px solid rgba(47,210,154,.34);border-radius:10px;background:rgba(7,29,35,.34);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:7px;padding:8px 4px;box-sizing:border-box}.a236-zone svg{width:42px;height:42px;fill:none;stroke:#39d6a0;stroke-width:2}.a236-zone span{font-size:11px;line-height:1.1;color:var(--text-2);white-space:nowrap}.a236-eq{font-size:12px;color:#9fc3db}
.a236-outside{display:grid;grid-template-columns:auto 22px auto 22px auto 26px minmax(150px,1fr);align-items:center;gap:8px;border-top:1px dashed rgba(80,162,211,.35);padding-top:12px}.a236-outside .label{font-size:11px;letter-spacing:.08em;color:#86add0}.a236-out{display:grid;justify-items:center;gap:3px}.a236-out svg{width:28px;height:28px;fill:none;stroke:#77a9cf;stroke-width:2}.a236-out span{font-size:10.5px;color:#aac1d3}.a236-mini-arrow{height:1px;background:#659bc1}.a236-mini-arrow.in{background:#27bdf0;position:relative}.a236-mini-arrow.in:after{content:"";position:absolute;right:-1px;top:-3px;border-left:6px solid #27bdf0;border-top:4px solid transparent;border-bottom:4px solid transparent}.a236-water-brand{display:flex;align-items:center;justify-content:flex-start;min-width:0}.a236-water-brand img{display:block;height:34px;width:auto;max-width:220px;object-fit:contain}
@media(max-width:900px){#architecture{padding:28px 0 26px!important}#architecture .a236{width:min(620px,calc(100% - 28px));gap:16px}.a236-head{text-align:left;justify-items:start}.a236-head h2{font-size:clamp(28px,9vw,38px)}.a236-head p{font-size:16px}.a236-grid{grid-template-columns:1fr}.a236-left,.a236-right{padding:16px}.a236-flow{grid-template-columns:1fr;gap:9px;min-height:0}.a236-node,.a236-zones{height:auto;min-height:190px}.a236-arrow{width:2px;height:20px;justify-self:center}.a236-arrow:after{right:-4px;top:auto;bottom:-1px;border-left:5px solid transparent;border-right:5px solid transparent;border-top:8px solid #27bdf0;border-bottom:0}.a236-zones-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.a236-zone{min-height:88px}.a236-outside{grid-template-columns:1fr;gap:8px;text-align:center}.a236-mini-arrow{width:2px;height:14px;justify-self:center}.a236-mini-arrow.in{width:2px;height:16px}.a236-mini-arrow.in:after{right:-4px;top:auto;bottom:-1px;border-left:5px solid transparent;border-right:5px solid transparent;border-top:8px solid #27bdf0;border-bottom:0}.a236-water-brand{justify-content:center}.a236-water-brand img{height:34px;max-width:220px}}
`;
  ...
  function render(){
    ...
    section.innerHTML=`<div class="a236">
      <header class="a236-head"><h2 id="a236-title">З ЧОГО СКЛАДАЄТЬСЯ BB610 WATER</h2><p>CONTROL, HYDRAULIC, ZONE та програмне керування працюють як одна система.</p></header>
      <div class="a236-grid">
        ...
        <section class="a236-right" aria-label="Функціональна схема BB610 WATER">
          ...
          <div class="a236-outside"><div class="label">ПОЗА СИСТЕМОЮ</div><div></div><div class="a236-out">${icon('water')}<span>Джерело води</span></div><div class="a236-mini-arrow"></div><div class="a236-out">${icon('pump')}<span>Насос подачі</span></div><div class="a236-mini-arrow"></div><div style="display:grid;grid-template-columns:auto 24px minmax(150px,1fr);align-items:center;gap:8px"><div class="a236-out">${icon('filter')}<span>Первинна фільтрація</span></div><div class="a236-mini-arrow in"></div><div class="a236-water-brand"><img src="assets/bb610-water-horizontal-logo.webp" alt="BB610 WATER"></div></div></div>
        </section>
      </div>
    </div>`;
  }
